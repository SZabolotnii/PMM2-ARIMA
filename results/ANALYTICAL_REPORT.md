...
## ARIMA Model Comparison: PMM2 vs Classical and Robust Methods on WTI Crude Oil Prices

---

**Report Generated:** 2025-10-31 11:47:46.632018
...
5. **Monte Carlo Benchmark:** PMM2 preserves Gaussian efficiency (RE ≈ 0.97, vs M-EST ≈ 0.95) and outperforms both CSS-ML and M-EST under skewed innovations.
...
| 4 | ARIMA(1,1,0) | PMM2 | 5123.80 | 5128.93 | 1.8803 | 1.3450 | 5.906 | 0.237 |
| 5 | ARIMA(0,1,1) | CSS-ML | 5122.40 | 5132.66 | 1.8801 | 1.3452 | 5.859 | 0.001 |
| 6 | ARIMA(1,1,0) | CSS-ML | 5122.48 | 5132.74 | 1.8801 | 1.3454 | 5.847 | 0.067 |
...
| Time | 0.0185 s | 0.0480 s | +0.0295 s |

---

## 5. MONTE CARLO EXPERIMENT: SYNTHETIC VALIDATION

Synthetic simulations benchmark PMM2, CSS-ML, and robust Hubers M-estimators under controlled innovation distributions.

### 5.1 Mean Relative Efficiency (ARIMA(1,1,0), $\phi_1$)

| Distribution | Method | Mean RE | Mean VR (%) |
|--------------|--------|---------|--------------|
| Gaussian | CSS | 1.000 | -- |
| Gaussian | OLS | 1.000 | +0.0 |
| Gaussian | M-EST | 0.954 | -5.0 |
| Gaussian | PMM2 | 0.971 | -3.5 |
| Gamma | CSS | 1.000 | -- |
| Gamma | OLS | 1.000 | +0.0 |
| Gamma | M-EST | 1.162 | +13.2 |
| Gamma | PMM2 | 1.657 | +38.6 |
| Lognormal | CSS | 1.000 | -- |
| Lognormal | OLS | 1.000 | +0.0 |
| Lognormal | M-EST | 1.234 | +18.2 |
| Lognormal | PMM2 | 1.734 | +41.6 |
| Chi-squared | CSS | 1.000 | -- |
| Chi-squared | OLS | 1.000 | +0.0 |
| Chi-squared | M-EST | 1.237 | +18.4 |
| Chi-squared | PMM2 | 1.827 | +44.7 |

### 5.2 Key Observations

- **Gaussian innovations:** PMM2 mean RE = 0.97, M-EST = 0.95 (CSS/OLS baseline = 1.00).
- **Gamma innovations ($\gamma_3 \approx 1.4$):** PMM2 mean RE = 1.66 versus M-EST = 1.16.
- **Lognormal innovations ($\gamma_3 \approx 2.0$):** PMM2 mean RE = 1.73, M-EST = 1.23.
- **Chi-squared innovations ($\gamma_3 \approx 1.6$):** PMM2 mean RE = 1.83, M-EST = 1.24.
- **Alignment with manuscript tables:** average PMM2 RMSE ratio = 0.51 (1.00 indicates perfect agreement).

### 5.3 Sample Size Effect (PMM2 RE)

| Distribution | N=100 | N=200 | N=500 | N=1000 |
|--------------|-------|-------|-------|--------|
| Gaussian | 0.95 | 0.97 | 0.98 | 0.99 |
| Gamma | 1.61 | 1.65 | 1.75 | 1.63 |
| Lognormal | 1.76 | 1.73 | 1.71 | 1.74 |
| Chi-squared | 1.78 | 1.83 | 1.88 | 1.82 |

### 5.4 Residual Cumulants under PMM2

| Distribution | True Skew | Residual Skew (mean ± sd) | Residual Kurtosis (mean ± sd) |
|--------------|-----------|---------------------------|-------------------------------|
| Gaussian | 0.00 | 0.00 ± 0.11 | -0.00 ± 0.22 |
| Gamma | 1.41 | 1.39 ± 0.23 | 2.81 ± 1.65 |
| Lognormal | 2.00 | 1.90 ± 0.54 | 6.67 ± 6.21 |
| Chi-squared | 1.63 | 1.60 ± 0.26 | 3.75 ± 2.08 |

---

## 6. PARAMETER ESTIMATE MSE RATIO
...
|-------|----------------|---------------|----------------|
| ARIMA(0,1,1) | 0.0010 | 0.0030 | 0.33x |
| ARIMA(1,1,0) | 0.0670 | 0.2370 | 0.28x |
| ARIMA(1,1,1) | 0.0020 | 0.0030 | 0.67x |
| ARIMA(2,1,1) | 0.0080 | 0.0090 | 0.89x |
| ARIMA(1,1,2) | 0.0100 | 0.0110 | 0.91x |
| ARIMA(2,1,2) | 0.0230 | 0.0250 | 0.92x |

**Average Speedup:** 0.39x (CSS-ML is faster)
...
2. **Method Comparison**
   ...
   - Monte Carlo (Section 5): PMM2 keeps Gaussian efficiency (RE ≈ 0.97, M-EST ≈ 0.95) and delivers RE 1.66–1.83 under skewed innovations; Hubers M-estimator bridges CSS-ML and PMM2 with intermediate gains
...
4. **Computational Cost**
   ...
   - But difference is negligible (2.59x)
...
**When to use Huber M-estimators:**
- Need additional robustness with minimal efficiency loss (Gaussian RE ≈ 0.95)
- Desire intermediate gains on skewed distributions (Monte Carlo RE typically 1.16–1.24)
- Useful as a secondary estimator for validation alongside PMM2
...
- Consider ensemble methods combining CSS-ML, PMM2, and robust estimators for stress-testing results
...
- **Report Generated:** 2025-10-31 11:47:46.688924
