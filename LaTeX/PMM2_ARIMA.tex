...
\begin{itemize}
    ...
    \item \textbf{Емпірична валідація:} У WTI case study (розділ~\ref{sec:empirical_wti}) переваги PMM2 підтверджуються незалежними метриками (RMSE, MAE), що не базуються на припущеннях про правдоподібність.
\end{itemize}
