...
Розглянемо детально застосування стохастичного поліному другого порядку (PMM2) на прикладі простої двокомпонентної лінійної регресії із асиметрично-розподіленою випадковою складовою.
...
Для максимізації стохастичного полінома~\eqref{eq:pmm2_polynomial_vector} оптимальні коефіцієнти $k_{i,v}^{(p)}$, $i=1,2$, знаходяться з розв'язання системи лінійних алгебраїчних рівнянь:
\begin{equation}
